    ...
    (loop
        ...
        (if (numberp option)
            (if (= 0 option)
                ...
                (if (= 1 option)
                    (progn
                        (let ((graph nil) (archive nil) (graph-type nil) (nodes-first nil))
                            ...
                            (run-analysis graph :verbose t)
                            (print-graph-info graph :verbose t)))                    
                    (let ((graph nil) (number-of-nodes nil) (graph-type nil) (edge-prob nil))
                        (loop 
